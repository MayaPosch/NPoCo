/*
	Thread_WIN32.h - Definition of the ThreadImpl class for WIN32.
*/


#ifndef Core_Thread_WIN32_INCLUDED
#define Core_Thread_WIN32_INCLUDED
...
#endif // Core_Thread_WIN32_INCLUDED
