/*
	Thread_FreeRTOS.h - Definition of the ThreadImpl class for FreeRTOS Threads.
*/


#ifndef Core_Thread_FreeRTOS_INCLUDED
#define Core_Thread_FreeRTOS_INCLUDED
...
#endif // Core_Thread_FreeRTOS_INCLUDED
