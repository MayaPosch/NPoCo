...
bool format(std::string& result, const char *fmt, const std::vector<Any>& values) {
	return format(result, std::string(fmt), values);
}


bool format(std::string& result, const std::string& fmt, const std::vector<Any>& values) {
