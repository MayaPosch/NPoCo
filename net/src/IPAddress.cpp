...
{
	// Debug
	std::cout << "IPAddress constructor. Addr: " << addr << std::endl;
	...
	// Debug
	std::cout << "Parsing IPv4..." << std::endl;

	IPv4AddressImpl addr4(IPv4AddressImpl::parse(addr));
	if (addr4 != empty4)
	{
		// debug
		std::cout << "Parsed IPv4, calling newIPv4()." << std::endl;
